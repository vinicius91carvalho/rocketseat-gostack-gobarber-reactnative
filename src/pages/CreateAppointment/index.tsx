...
const CreateAppointment: React.FC = () => {
    ...
    const handleCreateAppointment = useCallback(async () => {
        try {
            ...
            Alert.alert('Erro ao criar agendamento', 'Ocorreu um erro ao tentar o agendamento, tente novamente');
        }
                            ...
                            >
                                <ProviderAvatar
                                    source={{
                                        uri:
                                            provider.avatar_url ||
                                            'http://localhost:3333/files/1ec9c6d46931cef4c27f-unnamed.jpg',
                                    }}
                                />
                                <ProviderName
                                    selected={provider.id === selectedProvider}
